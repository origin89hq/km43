...
use crate::generated::{
    ...
    CommsReleaseOp, DisconnectReason, DownloadReason, EnterDownload, LinkDirection, LinkErrorCode,
...
mod tests {
    ...
    /// The nine link requests, none of which had a truncation test. The
    ...
    /// The seven acks, cut the same way.
    #[test]
