...
|---|---|---|
| After the tag verifies, before counter persist | operation did not execute; client's retry with a new counter succeeds | P-080's stated fail-closed |
